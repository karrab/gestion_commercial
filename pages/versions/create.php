...
$auth->requirePermission('versions', 'create');
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        $db->prepare("INSERT INTO versions (num_version, date, direction, developpe_par, notes)
                      VALUES (:num_version, :date, :direction, :developpe_par, :notes)");
        ...
        $auth->logTrace($auth->getUserId(), 'versions', 'create', 'versions', $db->lastInsertId(), 'Création version ' . $data['num_version']);

        $_SESSION['success'] = 'Version créée avec succès.';
...
<div class="container-fluid main-container">
    <div class="row mb-4">
        <div class="col-12">
            <h2><i class="bi bi-tag"></i> Nouvelle version</h2>
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header"><i class="bi bi-plus-circle"></i> Informations de la version</div>
                <div class="card-body">
                    <form method="POST">
                        <div class="row">
                            <div class="col-md-4 mb-3">
                                ...
                                <input type="text" class="form-control" id="num_version" name="num_version"
                                       value="<?php echo htmlspecialchars($data['num_version']); ?>"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control" id="notes" name="notes" rows="5"
                                      placeholder="Description des changements, nouvelles fonctionnalités, corrections..."><?php echo htmlspecialchars($data['notes']); ?></textarea>
                        </div>
